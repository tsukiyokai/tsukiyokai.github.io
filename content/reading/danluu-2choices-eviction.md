...
[return]
  ...
  5. If you know of a cache simulator for some other domain that I can use, please [let me know](<https://twitter.com/danluu>)! [return]


[← CLWB and PCOMMIT](<https://danluu.com/clwb-pcommit/>) [Testing v. informal reasoning →](<https://danluu.com/tests-v-reason/>)
