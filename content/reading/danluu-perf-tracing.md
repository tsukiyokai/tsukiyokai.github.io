...
For more on this, let's look at [this wide ranging Dick Sites talk](<https://www.youtube.com/watch?v=QBu2Ae8-8LM>)1 which covers, among other things, [the performance tracing framework that Dick and others have created at Google](<http://www.pdl.cmu.edu/SDI/2015/slides/DatacenterComputers.pdf>). By capturing “every” event that happens, it lets us easily debug performance oddities that would otherwise be difficult to track down. We'll take a look at three different bugs to get an idea about the kinds of problems Google's tracing framework is useful for.
...
[← su3su2u1 physics tumblr archive](<https://danluu.com/su3su2u1/physics/>) [We saw some really bad Intel CPU bugs in 2015 and we should expect to see more in the future →](<https://danluu.com/cpu-bugs/>)
