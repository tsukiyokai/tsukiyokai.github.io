...
And here's some testing related stuff of mine: [everything is broken](<https://danluu.com/everything-is-broken/>), [builds are broken](<https://danluu.com/broken-builds/>), [julia is broken](<https://danluu.com/julialang/>), and [automated bug finding using analytics](<https://danluu.com/new-cpu-features/>).
