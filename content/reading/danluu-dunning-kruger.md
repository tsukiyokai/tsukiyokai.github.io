...
[← We used to build steel mills near cheap power. Now that's where we build datacenters](<https://danluu.com/datacenter-power/>) [Given that we spend little on testing, how should we test software? →](<https://danluu.com/testing/>)
