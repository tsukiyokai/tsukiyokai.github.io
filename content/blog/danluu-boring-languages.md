...
[HAProxy](<http://en.wikipedia.org/wiki/HAProxy>) AWS Lambda workers (with most of the surrounding infrastructure written in Java), according to @jayachdee
...
[← The googlebot monopoly](<https://danluu.com/googlebot-monopoly/>) [Advantages of monorepos →](<https://danluu.com/monorepo/>)
