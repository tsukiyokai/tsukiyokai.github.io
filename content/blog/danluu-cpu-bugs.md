...
* * *
  ...
  4. See [this code](<https://github.com/vishmohan/vmlaunch>) for a simple example of how to use Intel's API for this. The example is simplified, so much so that it's not really useful except as a learning aid, and it still turns out to be around 1000 lines of low-level code. [return]


[← Sampling v. tracing](<https://danluu.com/perf-tracing/>) [Normalization of deviance →](<https://danluu.com/wat/>)
