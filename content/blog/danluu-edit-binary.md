...
Simple! If you do this a bit more, you'll soon get in the habit of patching in `90`3 to overwrite things with NOPs. For example, if we replace `0f 8e 16 00 00 00; jle` and `e9 11 00 00 00; jmpq` with `90`, we get the following:
...
[return]
  2. If you don't have $1000 to spare, [r2](<https://github.com/radare/radare2>) is a nice, free, tool with IDA-like functionality. [return]
  3. on x86 [return]


[← Data-driven bug finding](<https://danluu.com/bugalytics/>) [That bogus gender gap article →](<https://danluu.com/gender-gap/>)
