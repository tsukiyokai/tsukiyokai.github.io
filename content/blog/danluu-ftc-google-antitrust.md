...
[for these, I continued writing high-level summaries, not detailed summaries]
  ...
  * Memo from Willard K. Tom, General Counsel 
    * "In sum, this _may_ be a good case. But it would be a novel one, and as in all such cases, the Commission should think through carefully what it means."
...
[← A discussion of discussions on AI bias](<https://danluu.com/ai-bias/>) [How web bloat impacts users with slow devices →](<https://danluu.com/slow-device/>)
